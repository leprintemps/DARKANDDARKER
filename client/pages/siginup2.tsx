...
//   username: string().min(1, "Username is required").max(30),
//   .username("Username is invalid"),
//   password: string()
//   .min(1, "Password is required")
//   .min(8, "Password must be more than 8 characters")
//   .max(32, "Password must be less than 32 characters")
//   name: string().min(1, "Name is required").max(30),
...
//               <Typography variant='h4' component='h1' sx={{ textAlign: 'center', width: '100%', mb: '1.5rem', pb: { sm: '3rem' } }}>Welcome To Loop True!</Typography>
